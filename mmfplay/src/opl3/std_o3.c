...
struct opl3_instrument opl3_ins[128] = {
	...
	{ { 0x23, 0x15, 0xfd, 0x7c, 0x03 },	/* OP1 */
	  { 0x01, 0x08, 0x84, 0xf5, 0x00 },	/* OP2 */
	  { 0x23, 0x15, 0xfd, 0x7c, 0x03 },	/* OP3 */
	  { 0x01, 0x08, 0x84, 0xf5, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*   1: Bright Acoustic      */
	{ { 0x03, 0x7d, 0xf3, 0xf5, 0x00 },	/* OP1 */
	  { 0x01, 0x08, 0xf3, 0xf5, 0x04 },	/* OP2 */
	  { 0x03, 0x7d, 0xf3, 0xf5, 0x00 },	/* OP3 */
	  { 0x01, 0x08, 0xf3, 0xf5, 0x04 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*   2: Electric Grand Piano */
	{ { 0x03, 0x4d, 0xfb, 0x55, 0x04 },	/* OP1 */
	  { 0x01, 0x08, 0xf3, 0xc5, 0x04 },	/* OP2 */
	  { 0x03, 0x4d, 0xfb, 0x55, 0x04 },	/* OP3 */
	...
	{ { 0xc1, 0x08, 0xf2, 0x48, 0x00 },	/* OP1 */
	  ...
	  { 0xc1, 0x08, 0xf2, 0x48, 0x00 },	/* OP3 */
	  { 0x01, 0x21, 0xf2, 0x97, 0x00 } },	/* OP4 */
	0x11, 0x10
      },
      { OPL3_TYPE_4OP,	/*  40: Violin               */
	{ { 0x22, 0xca, 0xb4, 0x26, 0x04 },	/* OP1 */
	  { 0x21, 0x11, 0x44, 0x06, 0x04 },	/* OP2 */
	  { 0x22, 0xca, 0xb4, 0x26, 0x04 },	/* OP3 */
	  { 0x21, 0x11, 0x44, 0x06, 0x04 } },	/* OP4 */
	0x1c, 0x11
      },
      { OPL3_TYPE_4OP,	/*  41: Viola                */
	{ { 0x24, 0xcb, 0x88, 0x26, 0x04 },	/* OP1 */
	  { 0x21, 0x10, 0x66, 0x16, 0x04 },	/* OP2 */
	  { 0x24, 0xcb, 0x88, 0x26, 0x04 },	/* OP3 */
	  { 0x21, 0x10, 0x66, 0x16, 0x04 } },	/* OP4 */
	0x1c, 0x11
      },
      { OPL3_TYPE_4OP,	/*  42: Cello                */
	{ { 0x22, 0xcb, 0x72, 0x46, 0x04 },	/* OP1 */
	  { 0x01, 0x1c, 0x5f, 0x86, 0x04 },	/* OP2 */
	  { 0x22, 0xcb, 0x72, 0x46, 0x04 },	/* OP3 */
	  { 0x01, 0x1c, 0x5f, 0x86, 0x04 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  43: Contrabass           */
	{ { 0x22, 0xff, 0x86, 0x06, 0x04 },	/* OP1 */
	  { 0x01, 0x08, 0x6f, 0x08, 0x04 },	/* OP2 */
	  { 0x22, 0xff, 0x86, 0x06, 0x04 },	/* OP3 */
	  { 0x01, 0x08, 0x6f, 0x08, 0x04 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  44: Tremolo Strings      */
	{ { 0x60, 0x00, 0x68, 0x04, 0x02 },	/* OP1 */
	  { 0x61, 0x09, 0x53, 0x45, 0x03 },	/* OP2 */
	  { 0x60, 0x00, 0x68, 0x04, 0x02 },	/* OP3 */
	  { 0x61, 0x09, 0x53, 0x45, 0x03 } },	/* OP4 */
	0x11, 0x11
      },
      { OPL3_TYPE_4OP,	/*  45: Pizzicato String     */
	{ { 0x00, 0x07, 0xf9, 0xf1, 0x03 },	/* OP1 */
	  { 0x00, 0x08, 0xf6, 0x34, 0x02 },	/* OP2 */
	  { 0x00, 0x07, 0xf9, 0xf1, 0x03 },	/* OP3 */
	  { 0x00, 0x08, 0xf6, 0x34, 0x02 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  46: Orchestral Harp      */
	{ { 0x12, 0xd0, 0xb5, 0x23, 0x04 },	/* OP1 */
	  { 0x01, 0x17, 0xc3, 0xe3, 0x00 },	/* OP2 */
	  { 0x12, 0xd0, 0xb5, 0x23, 0x04 },	/* OP3 */
	  { 0x01, 0x17, 0xc3, 0xe3, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  47: Timpani              */
	{ { 0x11, 0xd0, 0xe4, 0xe4, 0x01 },	/* OP1 */
	  { 0x10, 0x08, 0xd3, 0xf4, 0x00 },	/* OP2 */
	  { 0x11, 0xd0, 0xe4, 0xe4, 0x01 },	/* OP3 */
	  { 0x10, 0x08, 0xd3, 0xf4, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  48: String Ensemble1     */
	{ { 0x21, 0x1b, 0xa9, 0x23, 0x00 },	/* OP1 */
	  { 0x21, 0xc8, 0x63, 0x25, 0x04 },	/* OP2 */
	  { 0x21, 0x1b, 0xa9, 0x23, 0x00 },	/* OP3 */
	  { 0x21, 0xc8, 0x63, 0x25, 0x04 } },	/* OP4 */
	0x1e, 0x11
      },
      { OPL3_TYPE_4OP,	/*  49: String Ensemble2     */
	{ { 0x21, 0x1f, 0xa9, 0x23, 0x00 },	/* OP1 */
	  { 0x21, 0xc8, 0x33, 0x15, 0x04 },	/* OP2 */
	  { 0x21, 0x1f, 0xa9, 0x23, 0x00 },	/* OP3 */
	  { 0x21, 0xc8, 0x33, 0x15, 0x04 } },	/* OP4 */
	0x1e, 0x11
      },
      { OPL3_TYPE_4OP,	/*  50: SynthStrings 1       */
	{ { 0x20, 0x08, 0x52, 0xb6, 0x02 },	/* OP1 */
	  { 0x01, 0x0c, 0x50, 0x15, 0x01 },	/* OP2 */
	  { 0x20, 0x08, 0x52, 0xb6, 0x02 },	/* OP3 */
	  { 0x01, 0x0c, 0x50, 0x15, 0x01 } },	/* OP4 */
	0x11, 0x11
      },
      { OPL3_TYPE_4OP,	/*  51: SynthStrings 2       */
	{ { 0x22, 0x48, 0x51, 0xa4, 0x04 },	/* OP1 */
	  { 0x01, 0xc2, 0x31, 0xf4, 0x01 },	/* OP2 */
	  { 0x22, 0x48, 0x51, 0xa4, 0x04 },	/* OP3 */
	  { 0x01, 0xc2, 0x31, 0xf4, 0x01 } },	/* OP4 */
	0x11, 0x11
      },
      { OPL3_TYPE_4OP,	/*  52: Choir Aahs           */
	{ { 0x21, 0x10, 0x61, 0x04, 0x00 },	/* OP1 */
	  { 0x21, 0x08, 0x66, 0x45, 0x04 },	/* OP2 */
	  { 0x21, 0x10, 0x61, 0x04, 0x00 },	/* OP3 */
	  { 0x21, 0x08, 0x66, 0x45, 0x04 } },	/* OP4 */
	0x1a, 0x11
      },
      { OPL3_TYPE_4OP,	/*  53: Voice Oohs           */
	{ { 0x21, 0x16, 0xa6, 0x66, 0x00 },	/* OP1 */
	  { 0x21, 0x08, 0x77, 0x06, 0x00 },	/* OP2 */
	  { 0x21, 0x16, 0xa6, 0x66, 0x00 },	/* OP3 */
	  { 0x21, 0x08, 0x77, 0x06, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  54: Synth Voice          */
	{ { 0x21, 0x12, 0x75, 0x66, 0x00 },	/* OP1 */
	  { 0x21, 0x08, 0x67, 0x06, 0x00 },	/* OP2 */
	  { 0x21, 0x12, 0x75, 0x66, 0x00 },	/* OP3 */
	  { 0x21, 0x08, 0x67, 0x06, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  55: Orchestra Hit        */
	{ { 0x02, 0x0e, 0x76, 0x34, 0x00 },	/* OP1 */
	  { 0x01, 0x08, 0x64, 0x35, 0x04 },	/* OP2 */
	  { 0x02, 0x0e, 0x76, 0x34, 0x00 },	/* OP3 */
	  { 0x01, 0x08, 0x64, 0x35, 0x04 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  56: Trumpet              */
	{ { 0x21, 0x23, 0x72, 0x9b, 0x01 },	/* OP1 */
	  { 0x21, 0x08, 0x72, 0x3b, 0x04 },	/* OP2 */
	  { 0x21, 0x23, 0x72, 0x9b, 0x01 },	/* OP3 */
	  { 0x21, 0x08, 0x72, 0x3b, 0x04 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  57: Trombone             */
	{ { 0x21, 0x23, 0x63, 0x9b, 0x01 },	/* OP1 */
	  { 0x21, 0x08, 0x62, 0x3b, 0x04 },	/* OP2 */
	  { 0x21, 0x23, 0x63, 0x9b, 0x01 },	/* OP3 */
	  { 0x21, 0x08, 0x62, 0x3b, 0x04 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  58: Tuba                 */
	{ { 0x01, 0x14, 0x62, 0x0b, 0x05 },	/* OP1 */
	  { 0x01, 0x08, 0xe6, 0x2b, 0x05 },	/* OP2 */
	  { 0x01, 0x14, 0x62, 0x0b, 0x05 },	/* OP3 */
	  { 0x01, 0x08, 0xe6, 0x2b, 0x05 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  59: Muted Trumpet        */
	{ { 0x01, 0x11, 0x60, 0xfb, 0x05 },	/* OP1 */
	  { 0x21, 0x18, 0x62, 0x7b, 0x00 },	/* OP2 */
	  { 0x01, 0x11, 0x60, 0xfb, 0x05 },	/* OP3 */
	  { 0x21, 0x18, 0x62, 0x7b, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_2OP,	/*  60: French Horn          */
	{ { 0x21, 0x23, 0x41, 0x94, 0x00 },	/* OP1 */
	  { 0x21, 0x08, 0x81, 0xf6, 0x00 },	/* OP2 */
	  { 0x21, 0x23, 0x41, 0x94, 0x00 },	/* OP3 */
	  { 0x21, 0x08, 0x81, 0xf6, 0x00 } },	/* OP4 */
	0x1e, 0x0f
      },
      { OPL3_TYPE_4OP,	/*  61: Brass Section        */
	{ { 0x22, 0x4c, 0x75, 0x37, 0x01 },	/* OP1 */
	  { 0x61, 0x48, 0xf1, 0xb7, 0x05 },	/* OP2 */
	  { 0x22, 0x4c, 0x75, 0x37, 0x01 },	/* OP3 */
	  { 0x61, 0x48, 0xf1, 0xb7, 0x05 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  62: Synth Brass 1        */
	{ { 0x21, 0x04, 0x82, 0xcb, 0x01 },	/* OP1 */
	  { 0x21, 0x09, 0x71, 0x2b, 0x01 },	/* OP2 */
	  { 0x21, 0x04, 0x82, 0xcb, 0x01 },	/* OP3 */
	  { 0x21, 0x09, 0x71, 0x2b, 0x01 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  63: Synth Brass 2        */
	{ { 0x21, 0x83, 0x84, 0x3b, 0x01 },	/* OP1 */
	  { 0x21, 0x4d, 0xa2, 0x3b, 0x00 },	/* OP2 */
	  { 0x21, 0x83, 0x84, 0x3b, 0x01 },	/* OP3 */
	  { 0x21, 0x4d, 0xa2, 0x3b, 0x00 } },	/* OP4 */
	0x16, 0x11
      },
      { OPL3_TYPE_4OP,	/*  64: Soprano Sax          */
	{ { 0x01, 0x15, 0x70, 0xe7, 0x05 },	/* OP1 */
	  { 0x02, 0x08, 0x70, 0xe8, 0x00 },	/* OP2 */
	  { 0x01, 0x15, 0x70, 0xe7, 0x05 },	/* OP3 */
	  { 0x02, 0x08, 0x70, 0xe8, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  65: Alto Sax             */
	{ { 0x01, 0x13, 0x70, 0xe9, 0x05 },	/* OP1 */
	  { 0x01, 0x08, 0x70, 0xe9, 0x00 },	/* OP2 */
	  { 0x01, 0x13, 0x70, 0xe9, 0x05 },	/* OP3 */
	  { 0x01, 0x08, 0x70, 0xe9, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  66: Tenor Sax            */
	{ { 0x01, 0x15, 0x70, 0xeb, 0x05 },	/* OP1 */
	  { 0x01, 0x08, 0x70, 0xea, 0x00 },	/* OP2 */
	  { 0x01, 0x15, 0x70, 0xeb, 0x05 },	/* OP3 */
	  { 0x01, 0x08, 0x70, 0xea, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  67: Baritone Sax         */
	{ { 0x01, 0x11, 0xa4, 0xbb, 0x00 },	/* OP1 */
	  { 0x04, 0x0d, 0x67, 0x6a, 0x00 },	/* OP2 */
	  { 0x01, 0x11, 0xa4, 0xbb, 0x00 },	/* OP3 */
	  { 0x04, 0x0d, 0x67, 0x6a, 0x00 } },	/* OP4 */
	0x10, 0x11
      },
      { OPL3_TYPE_4OP,	/*  68: Oboe                 */
	{ { 0x11, 0x17, 0x70, 0x29, 0x00 },	/* OP1 */
	  { 0x34, 0x08, 0x61, 0x29, 0x00 },	/* OP2 */
	  { 0x11, 0x17, 0x70, 0x29, 0x00 },	/* OP3 */
	  { 0x34, 0x08, 0x61, 0x29, 0x00 } },	/* OP4 */
	0x10, 0x01
      },
      { OPL3_TYPE_4OP,	/*  69: English Horn         */
	{ { 0x01, 0x11, 0xf0, 0x29, 0x00 },	/* OP1 */
	  { 0x24, 0x08, 0x80, 0x09, 0x00 },	/* OP2 */
	  { 0x01, 0x11, 0xf0, 0x29, 0x00 },	/* OP3 */
